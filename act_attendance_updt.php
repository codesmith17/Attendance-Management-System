            ...
            <center>
                <form method="post" role="form" enctype="multipart/form-data">
                    <?php                                             
                                     ...
                                     ?>
                    <a href="#">
                        <i class="fa fa-user fa-2x" id="<?php echo $v->s_enrl;?>" name="<?php echo $v->s_enrl;?>" <?php
                    ...
                    <input type="hidden" value="<?php echo $v->s_enrl; ?>" id="<?php echo "r".$cnt; ?>"
                        name="<?php echo "r".$cnt; ?>">
                    <input type="hidden" name="<?php echo "ch".$v->s_enrl; ?>" id="<?php echo "ch".$v->s_enrl; ?>" <?php
                                     if(isset($_REQUEST["all_pr"]))
                                     {
                                         echo 'value="1"';
                                     }
                    ...
                    <center><br>
                        <button type="submit" id="att_submit_updt" name="att_submit_updt" value="submit"
