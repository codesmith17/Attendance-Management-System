                    ...
                    <form method="post" onSubmit="return validate_form(this)">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <td>
                                        <b>Select Academic Year:<select class="form-control" id="academic_yr"
                                                name="a_yr">
                                                <?php
                                                                        if (isset($a_yf)) {
                                                                              foreach ($a_yf as $y) {
                                                                                    ?>
                                                <option value="<?php echo $y->ac_year_id; ?>">
                                                    <?php echo $y->ac_year; ?>
                                                </option>
                                                <?php
                                                                              }
                                    ...
                                    <td>
                                        <b>Select Stream:<select class="form-control" id="c_id" name="c_id"
                                                onChange="return getYear(this.value)">
                                ...
                                <tr>
                                    <td><b>Select Year :<select id="year" class="form-control" name="year"
                                                onChange="return getSemester(this.value)">
                                            </select></b></td>
                                    <td>
                                        <b>Select Semester:<select class="form-control" id="semester" name="semester"
                                                onChange="return getSubject(this.value)">
                                            </select></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Select Subject :<select class="form-control" id="subject" name="subject"
                                                onchange="return getFac(this.value)">
                                            </select></b></td>
                                    <td><b>Faculty Name:<input type="text" name="fac" id="fac" class="form-control"
                                                disabled=""></b></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <b>Select Date:
                                            <input class="form-control" type="Date" name="dt" id="dt"
                                                ...
                                                onchange="return checkhd(this.value)" disabled="">
                                        </b>
                                    </td>
                                    <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <center>
                                        <button type="submit" id="act_submit_f" name="act_submit_f" value="submit"
                                            class="btn btn-primary" style="height: 100%; width: 30%;">Submit</button>
                                    </center>
                                </td>
                            </tr>
                        </table>
